...
#Region "Click event"
    ...
    Public Shared ReadOnly ClickEvent As RoutedEvent = EventManager.RegisterRoutedEvent("Click", RoutingStrategy.Bubble, GetType(RoutedEventHandler), GetType(ImageButton))
    ...
    Private Sub RaiseTapEvent()
        Dim newEventArgs As New RoutedEventArgs(ImageButton.ClickEvent)
        MyBase.RaiseEvent(newEventArgs)
    End Sub

    Private Sub RaiseClickEvent()
        Dim e As New RoutedEventArgs(ImageButton.ClickEvent)
        MyBase.RaiseEvent(e)
    End Sub
